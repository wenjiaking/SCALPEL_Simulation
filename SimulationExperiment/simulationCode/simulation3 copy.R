...
sim10Scalpel=scalpel("Desktop/simulation10/","Desktop/simulation10/data/",videoHeight = 200)
#191
par(mfrow=c(1,2))
spatialplot(sim9A,sim9Z,title="Neuron Footprints",border = TRUE,addToPlot = FALSE,videoheight = 200)
...
sim13Scalpel=scalpel("Desktop/simulation13/","Desktop/simulation13/data/",videoHeight = 200)
