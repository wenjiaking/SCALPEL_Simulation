...
for (rep in rep.vec) {
  for (noiseIndex in 1:length(SNR.vec)) {
    ...
    outfile = paste0(folder,"evalFiles/sensitivityPrecision/scalpel_minCluster5_rep",rep,"_SNR",SNR,"_",SNR_static,"_matchcut",cutoff_matching_pixels,"_extracut",cutoff_extra_pixels,".txt")
    ...
    outfile = paste0(folder,"evalFiles/matching/scalpel_minCluster5_rep",rep,"_SNR",SNR,"_",SNR_static,"_matchcut",cutoff_matching_pixels,"_extracut",cutoff_extra_pixels,".txt")
